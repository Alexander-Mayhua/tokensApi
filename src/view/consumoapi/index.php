    ...
    <div class="card p-4">
        ...
        <form id="formConsumo" method="POST">
            ...
            <input type="hidden" id="token" name="token"
                   value="16b75f62760d5cd712a1a4885e73aae6-251111-3">
            ...
            <div class="text-center mt-3">
                ...
                <a href="?c=consumoapi&a=form" class="btn btn-outline-secondary px-4 ms-2">
...
document.getElementById('formConsumo').addEventListener('submit', async function(e) {
    ...
    try {
        ...
        if (!data.status) {
            cont.innerHTML = `<div class="alert alert-warning">${data.mensaje || 'No se encontraron resultados.'}</div>`;
            return;
        }
        ...
        cont.innerHTML = '<div class="alert alert-danger">❌ Error al conectar con el servidor local.</div>';
    }
});
</script>
</body>
